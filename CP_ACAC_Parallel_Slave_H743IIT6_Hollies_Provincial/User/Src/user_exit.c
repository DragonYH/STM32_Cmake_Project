 ...
 * @LastEditTime : 2024-08-01 19:35:51
 * @FilePath     : \CP_ACAC_Parallel_Slave_H743IIT6_Hollies_Provincial\User\Src\user_exit.c
 * @Description  : 用户中断实现
 *
...
static void getVoltageCurrent(void)
{
    ...
    allSignal->voltageOut = adcValue[2] * 41.45040537f; /* 输出电压 */
}
