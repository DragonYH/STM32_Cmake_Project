...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOI, LEO0_Pin|OLED_DC_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, IR2104_SD1_Pin|IR2104_SD2_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = LEO0_Pin|OLED_DC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
  ...
  GPIO_InitStruct.Pin = IR2104_SD1_Pin|IR2104_SD2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
